...
#define ESP8266_CH_HIGH_LEVEL()  GPIO_SetBits(ESP8266_CTRL_PORT, ESP8266_CTRL_EN_PIN)
#define ESP8266_CH_LOW_LEVEL()   GPIO_ResetBits(ESP8266_CTRL_PORT, ESP8266_CTRL_EN_PIN)
#define ESP8266_RST_HIGH_LEVEL() GPIO_SetBits(ESP8266_CTRL_PORT, ESP8266_CTRL_RST_PIN)
#define ESP8266_RST_LOW_LEVEL()  GPIO_ResetBits(ESP8266_CTRL_PORT, ESP8266_CTRL_RST_PIN)
